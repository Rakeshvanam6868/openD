...
```
dfx canister call opend listItem '(principal "avqkn-guaaa-aaaaa-qaaea-cai", 2)'
```
...
```
dfx canister call avqkn-guaaa-aaaaa-qaaea-cai transferOwnership '(principal "br5f7-7uaaa-aaaaa-qaaca-cai", true)'
```
